...
const AuthVisual = () => (
    <>
      <div className="fixed inset-0 z-0 bg-[radial-gradient(ellipse_at_20%_30%,rgba(156,220,182,0.08)_0%,transparent_50%),radial-gradient(ellipse_at_80%_70%,rgba(100,150,200,0.08)_0%,transparent_50%),#0a0a0a]"></div>
