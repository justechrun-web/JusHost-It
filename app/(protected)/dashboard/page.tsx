...
import { RecentSites } from '@/app/(main)/components/recent-sites';
import { ResourceUsageChart } from '@/app/(main)/components/resource-usage-chart';
import { useDoc, useFirestore, useUser, useMemoFirebase } from '@/firebase';
import { doc } from 'firebase/firestore';
import { ActiveAlerts } from '@/app/(main)/components/active-alerts';
